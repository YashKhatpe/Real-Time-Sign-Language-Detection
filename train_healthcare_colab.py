...
# import sys
# sys.path.append(os.path.abspath("C:/Users/Yash Khatpe/Desktop/Yash/Mini Project/I3d_model/I3d_model/WLASL/I3D/datasets"))
...
torch.cuda.set_device(0)  # Use GPU 1 (RTX 3050)


def run(configs,
        mode='rgb',
        root={'word': '/data/videos1_preprocessed'},
        train_split='preprocess/nslt_40.json',
        save_model='',
        weights=None):
    print(configs)
    train_loss_list = []
    ...
    # print("Dataset size",len(dataloaders))
    ...
    while steps < configs.max_steps and epoch < 400:  # for epoch in range(num_epochs):
        ...
        for phase in ['train', 'test']:
            ...
            for data in dataloaders[phase]:
                ...
                per_frame_logits = i3d(inputs.float(), pretrained=False)
            ...
            if phase == 'test':
                ...
                val_loss = (tot_loss * num_steps_per_update) / num_iter
                ...
                avg_train_loss = tot_loss / num_iter
                train_loss_list.append(avg_train_loss)

                # Plot confusion matrix heatmap
                conf_mat_fig = plt.figure(figsize=(12, 10))
    ...
    # Accuracy Plot
    plt.subplot(1, 2, 2)
    plt.plot(epoch_list, val_accuracy_list, label='Validation Accuracy', color='green')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    ...
    # Save the plot
    plt.tight_layout()
    plt.savefig(os.path.join(save_model, 'training_plots.png'))
    plt.show()
...
if __name__ == '__main__':
    ...
    weights = None
    config_file = '/content/drive/MyDrive/I3D/configfiles/asl100.ini'

    configs = Config(config_file)
    print("Root:", root, train_split)
